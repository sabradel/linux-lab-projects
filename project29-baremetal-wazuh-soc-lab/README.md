...
## 🌐 Secure Connectivity (Tailscale VPN)
...
![Project Setup](screenshots/09-project-setup.png)
...
A brute-force login attempt was simulated on the Windows endpoint using:
